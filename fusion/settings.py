...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-35)&2n0ev2%bqna=qbecf96@hck1km1)2f(%!gd*x&!_2ej60u')
...
if 'RENDER' in os.environ:
    # 1. PRODUÇÃO (Render): Usa o servidor SMTP real (Outlook/Office365)
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_HOST = 'smtp.office365.com'
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True

    # O Render vai injetar seu e-mail e senha através do painel deles, de forma invisível
